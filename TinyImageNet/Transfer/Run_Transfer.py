...
import argparse
import torch
from Transfer.train_model import get_model
...
def main():
    ...
    parser.add_argument('--model_epochs', type=int, default=100, metavar='N', required=False)
    parser.add_argument('--model_pretrained', default=True, required=False)
    parser.add_argument('--model_step_size', type=int, default=40, metavar='S')

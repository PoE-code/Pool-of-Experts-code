...
def get_experts(args, Oracle, library):
    ...
    for primitiveTask in ImageNet_Superclass.keys():
        ...
        expert = network.pytorch_mobilenetV2.mobilenet_cl(outchannel=80, num_classes=len(priTask_idx))
        ...
        if args.scheduler:
            scheduler_S = optim.lr_scheduler.MultiStepLR(optimizer_S, [10, 15], 0.1)
